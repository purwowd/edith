...
import datetime
from app.service.PullAll_service import pullAll
...
# Function to get Wazuh API token
...
# ADB PATH (lokasi adbnya klo di linux bisa diubah env nya ke path adb (cari lokasi pake which adb))
ADB_PATH = os.getenv("ADB_PATH")
OUTPUT_DIR = os.getenv("OUTPUT_DIR")
DB_PATH = os.path.join(OUTPUT_DIR, "device_data.db")

#env buat history browser
